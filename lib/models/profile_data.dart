enum CareSubjectType { self, ward }
...
class ProfileConsent {
  ...
  const ProfileConsent({this.onDevice = true, this.acceptedAt});
...
class ProfileOwnership {
  final CareSubjectType subjectType;
  final String? relationship;

  const ProfileOwnership({
    this.subjectType = CareSubjectType.self,
    this.relationship,
  });

  bool get isSelf => subjectType == CareSubjectType.self;
  bool get isWard => subjectType == CareSubjectType.ward;
  ...
  factory ProfileOwnership.fromJson(Map<String, dynamic> json) {
    final type = CareSubjectType.values.firstWhere(
      (value) => value.name == json['subjectType'],
...
class ProfileStory {
  ...
  factory ProfileStory.fromJson(Map<String, dynamic> json) => ProfileStory(
    ...
    treatmentStage: json['treatmentStage'] != null
        ? TreatmentStage.values.firstWhere(
            (e) => e.name == json['treatmentStage'],
            orElse: () => TreatmentStage.unsure,
          )
        : null,
  );
}
...
class ProfileCurve {
  ...
  factory ProfileCurve.fromJson(Map<String, dynamic> json) => ProfileCurve(
    ...
    curveType: json['curveType'] != null
        ? CurveType.values.firstWhere(
            (e) => e.name == json['curveType'],
            orElse: () => CurveType.unsure,
          )
        : null,
...
class ProfileBrace {
  ...
  factory ProfileBrace.fromJson(Map<String, dynamic> json) => ProfileBrace(
    wears: json['wears'],
    type: json['type'] != null
        ? BraceType.values.firstWhere(
            (e) => e.name == json['type'],
            orElse: () => BraceType.other,
          )
        : null,
...
class ProfilePt {
  ...
  factory ProfilePt.fromJson(Map<String, dynamic> json) => ProfilePt(
    method: json['method'] != null
        ? PtMethod.values.firstWhere(
            (e) => e.name == json['method'],
            orElse: () => PtMethod.unsure,
          )
        : null,
  );
}
...
class ProfileSymptoms {
  ...
  factory ProfileSymptoms.fromJson(Map<String, dynamic> json) =>
      ProfileSymptoms(
...
class ProfileCompanion {
  ...
  factory ProfileCompanion.fromJson(Map<String, dynamic> json) =>
      ProfileCompanion(
        name: json['name'] ?? 'Vera',
...
class ProfileData {
  ...
  final ProfileOwnership ownership;
  ...
  const ProfileData({
    ...
    this.ownership = const ProfileOwnership(),
  ...
  factory ProfileData.fromJson(Map<String, dynamic> json) => ProfileData(
    consent: json['consent'] != null
        ? ProfileConsent.fromJson(json['consent'])
        : const ProfileConsent(),
    ownership: json['ownership'] != null
        ? ProfileOwnership.fromJson(json['ownership'])
        : const ProfileOwnership(),
    basics: json['basics'] != null
        ? ProfileBasics.fromJson(json['basics'])
        : const ProfileBasics(),
    body: json['body'] != null
        ? ProfileBody.fromJson(json['body'])
        : const ProfileBody(),
    story: json['story'] != null
        ? ProfileStory.fromJson(json['story'])
        : const ProfileStory(),
    curve: json['curve'] != null
        ? ProfileCurve.fromJson(json['curve'])
        : const ProfileCurve(),
    brace: json['brace'] != null
        ? ProfileBrace.fromJson(json['brace'])
        : const ProfileBrace(),
    pt: json['pt'] != null ? ProfilePt.fromJson(json['pt']) : const ProfilePt(),
    symptoms: json['symptoms'] != null
        ? ProfileSymptoms.fromJson(json['symptoms'])
        : const ProfileSymptoms(),
    goals:
        (json['goals'] as List<dynamic>?)
            ?.map(
              (e) => Goal.values.firstWhere(
                (g) => g.name == e,
                orElse: () => Goal.exploring,
              ),
            )
            .toList() ??
        [],
    companion: json['companion'] != null
        ? ProfileCompanion.fromJson(json['companion'])
